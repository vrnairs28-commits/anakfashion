...
export default function Footer() {
    ...
    const links = {
        ...
        boutique: [
            ...
            { name: 'Why Choose Aura', href: '/' },
            { name: 'Browse Catalog', href: '/products' },
        ],
        contact: {
            phone: '+91 98765 43210',
            whatsapp: 'https://wa.me/919876543210',
            email: 'hello@auraboutique.com',
        ...
        <footer className="bg-dark-gray text-white pt-16 pb-8 border-t border-gold/15">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    {/* Brand Info */}
                    <div>
                        <span className="font-serif text-3xl tracking-widest font-bold text-white block mb-2">AURA</span>
                        <span className="text-xs uppercase tracking-widest text-gold block mb-6">Boutique</span>
                        <p className="text-sm text-light-gray/70 leading-relaxed mb-6 font-light">
                            Crafting premium luxury fashion for the modern woman. Aura Boutique combines classic Indian tradition with contemporary global aesthetics, offering a curated selection of sarees, kurtis, and ethnic ensembles.
                        </p>
                    ...
                    {/* Contact Details */}
                    <div>
                        <h4 className="font-serif text-lg text-gold font-semibold tracking-wider mb-6">Boutique Address</h4>
                        ...
                        <div className="mt-8">
                            <h5 className="text-xs uppercase tracking-widest text-gold mb-3 font-semibold">Join The Aura Club</h5>
                            <div className="flex">
                                <input
                                    type="email"
                ...
                <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-light-gray/40">
                    <p>&copy; {currentYear} AURA Boutique. All rights reserved.</p>
